...
/**
* @param {Float32Array} query_embeddings_vec
* @param {Int32Array} filter_by_tags
* @returns {any}
*/
export function search(query_embeddings_vec, filter_by_tags) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayF32ToWasm0(query_embeddings_vec, wasm.__wbindgen_export_0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('embeddings_search_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
